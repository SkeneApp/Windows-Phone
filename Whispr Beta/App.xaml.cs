    ...
    public partial class App
    {
        ...
        private void Application_UnhandledException(object sender, ApplicationUnhandledExceptionEventArgs e)
        {
            ...
            string message = "Message:" + Environment.NewLine +
                e.ExceptionObject.Message + Environment.NewLine +
                "----------------" + Environment.NewLine +
                "Stack trace:" + Environment.NewLine +
                e.ExceptionObject.StackTrace + Environment.NewLine +
                "----------------" + Environment.NewLine +
                "Source:" + Environment.NewLine +
                e.ExceptionObject.Source + Environment.NewLine;
            if (e.ExceptionObject.InnerException != null) {
                message += "----------------" + Environment.NewLine +
                    "Inner exception:" + Environment.NewLine +
                    "Message:" + Environment.NewLine +
                    e.ExceptionObject.InnerException.Message + Environment.NewLine +
                    "----------------" + Environment.NewLine +
                    "Stack trace:" + Environment.NewLine +
                    e.ExceptionObject.InnerException.StackTrace + Environment.NewLine +
                    "----------------" + Environment.NewLine +
                    "Source:" + Environment.NewLine +
                    e.ExceptionObject.InnerException.Source + Environment.NewLine;
            }
            if (e.ExceptionObject.Data != null) {
                message += "----------------" + Environment.NewLine +
                    "Data:" + Environment.NewLine;
                foreach (DictionaryEntry de in e.ExceptionObject.Data) {
                    message += de.Key + ": " + de.Value + Environment.NewLine;
                }
            }
